...
-----------------------------------| -----------------|------------------------
[Выводы из неудачных заказов](https://github.com/kozikoffartem/Statistik_uber_allen/blob/main/Выводы%20из%20неудачных%20заказов/Выводы_из_неудачных_заказов.ipynb) |Исследование неудачных заказов для приложения по управлению корпоративным наземным транспортом (GTM)| *pandas, numpy, datetime, matplotlib, seaborn, scipy*
